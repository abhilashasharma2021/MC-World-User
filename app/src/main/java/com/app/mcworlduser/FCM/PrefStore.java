...
public class PrefStore {
    ...
    private static final String PREFS_NAME = "YourApp";
    ...
    public <T extends Object> void setData(String value, ArrayList<T> datas) {
        getPref().edit().putString(value, ObjectSerializerOld.serialize(datas)).commit();
    }

    public <T extends Object> ArrayList<T> getData(String name) {

        return (ArrayList<T>) ObjectSerializerOld.deserialize(getPref().
                getString(name, ObjectSerializerOld.serialize(new ArrayList<T>())));
    }
}
